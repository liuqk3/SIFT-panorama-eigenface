...
%     image_stitch = zeros([im1_size(1:2)+im2_size(1:2),3]);
%     image_stitch(1:im1_size(1),1:im1_size(2),:) = image1.image;
%     image_stitch(im1_size(1)+1:im1_size(1)+im2_size(1),im1_size(2)+1:im1_size(2)+im2_size(2),:) = image2.image;
else
    image_stitch = zeros([ max(im1_size(1),im2_size(1)), im1_size(2)+im2_size(2)]);
    image_stitch(1:im1_size(1),1:im1_size(2)) = image1.image;
    image_stitch(1:im2_size(1),im1_size(2)+1:im1_size(2)+ im2_size(2)) = image2.image;
    
%     image_stitch = zeros(im1_size(1:2)+im2_size(1:2));
%     image_stitch(1:im1_size(1),1:im1_size(2)) = image1.image;
%     image_stitch(im1_size(1)+1:im1_size(1)+im2_size(1),im1_size(2)+1:im1_size(2)+im2_size(2)) = image2.image;
end
